...
public class PatientMedicExaminationAdapter extends RecyclerView.Adapter<PatientMedicExaminationAdapter.ViewHolder> {
    ...
    public PatientMedicExaminationAdapter(Context context, Patient patient) {
